...
class SmarsRobot():
    ...
    # newLeg = leg()
    legs = []
    self.legs.append(leg('left_foot_front',0))
    self.legs.append(leg('left_foot_back',3))
    self.legs.append(leg('right_foot_front',6))
    self.legs.append(leg('right_foot_back'),5)
    self.legs[0].show()
